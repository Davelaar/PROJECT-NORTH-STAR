...
export type Messages = {
  ...
  submitProfile: {
    ...
    optionalCalibrationLead: string;
    contributorName: string;
    title: string;
    notes: string;
    printTempsHeading: string;
    nozzleTempFirstLayer: string;
    nozzleTempOtherLayers: string;
    bedTempFirstLayer: string;
    bedTempOtherLayers: string;
    extrusionHeading: string;
    flowRatio: string;
    pressureAdvance: string;
    maxVolumetricFlow: string;
    minVolumetricFlow: string;
    coolingHeading: string;
    fanMin: string;
    fanMax: string;
    bridgeFan: string;
    fanDisableFirstLayers: string;
    dimensionalHeading: string;
    shrinkageXy: string;
    shrinkageZ: string;
    filamentDiameter: string;
    filamentDensity: string;
    retractionHeading: string;
